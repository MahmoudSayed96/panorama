...
namespace App\Http\Requests\Admin\Consulting\Company;
...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'client_phone' => ['required', 'max:190', Rule::unique('company_consultings', 'client_phone')->ignore($this->id)],
            'project_name' => ['required', 'string', 'min:3', 'max:190'],
            'project_number' => ['required', 'max:190'],
            'piece_number' => ['required', 'max:190'],
            'suk_number' => ['required', 'max:190'],
            'project_name' => [],
            'photos' => ['required'],
