...
namespace App\Http\Requests\Admin\Decorations\ClientDecoration;
...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'client_phone' => ['required', 'max:190', Rule::unique('company_decorations', 'client_phone')->ignore($this->id)],
