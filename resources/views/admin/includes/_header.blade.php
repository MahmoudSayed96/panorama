...
<header class="app-header">
    <a class="app-header__logo" href="{{route('admin.welcome')}}">{{config('app.name')}}</a>
    ...
    <ul class="app-nav">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><i class="fa fa-user fa-lg"></i></a>
            <ul class="dropdown-menu settings-menu dropdown-menu-right">
                <li><a class="dropdown-item" href="page-user.html"><i class="fa fa-cog fa-lg"></i>الاعدادت</a></li>
                <li><a class="dropdown-item" href="page-user.html"><i class="fa fa-user fa-lg"></i> الصفحة الشخصية</a></li>
                <li><a class="dropdown-item" href="{{ route('admin.logout') }}"><i class="fa fa-sign-out fa-lg"></i> تسجيل الخروج</a></li>
            </ul>
        </li>
    </ul>
</header>
