...
<div class="row">
    <div class="col-12">
        <div class="tile">
            <h3 class="tile-title">تعديل | ايجار برنامج </h3>
            <div class="tile-body">
                <form action="{{ route('admin.investments.rents.update',$rent->id) }}" method="post">
                    @csrf
                    <div class="form-group">
                        ...
                        <select class="form-control select2 @error('product') is-invalid @enderror" name="product"
                            ...
                            <optgroup label="اختر نوع المنتج">
                                ...
                                <option value="{{$product->id}}" {{ $product->id == $rent->product_id ? 'selected':''}}>
                                    {{ $product->name }}</option>
                                @endforeach
                            </optgroup>
                        </select>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="client_name" id="client_name" value="{{ $rent->client_name }}"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" min="0.0" step="0.01" name="price" id="price" placeholder="0.00"
                                    value="{{ $rent->price }}" class="form-control @error('price') is-invalid @enderror"
                                    required>
                                @error('price')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
