...
<div class="row">
    <div class="col-12">
        <div class="tile">
            <h3 class="tile-title">اضافة | عميل قسط / تمويل </h3>
            <div class="tile-body">
                <form action="{{ route('admin.investments.premiums.store') }}" method="post">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" min="0.0" step="0.01" name="alqist_amount" id="alqist_amount"
                                    value="{{ old('alqist_amount') }}" placeholder="0.00"
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" min="0.0" step="0.01" name="remaining_amount" id="remaining_amount"
                                    placeholder="0.00" value="{{ old('remaining_amount') }}"
