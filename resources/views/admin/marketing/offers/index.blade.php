    ...
    <div class="col-12">
        ...
        <div class="tile">
            ...
            <div class="tile-title">
                <a href="{{ route('admin.marketing.offers.create') }}" class="btn btn-success">اضاف جديد <i
                                ...
                                <table class="table table-hover table-bordered dataTable no-footer text-center" id="dt"
                                    ...
                                    <tbody>
                                        ...
                                        <tr role="row" class="{{ $index % 2 == 0 ? 'even' : 'odd' }}">
                                            ...
                                            <td>
                                                @if (currentUser()->hasPermission('read_marketing'))
                                                ...
                                                <form action="{{ route('admin.marketing.offers.delete',$offer->id) }}"
