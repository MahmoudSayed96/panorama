    ...
    <div class="col-12">
        ...
        <div class="tile">
            ...
            <div class="tile-title">
                <a href="{{ route('admin.marketing.sales.company.create') }}" class="btn btn-success">اضاف جديد <i
                                    ...
                                    <tbody>
                                        ...
                                        <tr role="row" class="{{ $index % 2 == 0 ? 'even' : 'odd' }}">
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('admin.marketing.sales.company.edit',$company->id) }}"
                                                ...
                                                <form
                                                    action="{{ route('admin.marketing.sales.company.delete',$company->id) }}"
