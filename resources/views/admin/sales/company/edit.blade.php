...
<div class="app-title">
    ...
    <ul class="app-breadcrumb breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('admin.sales.company') }}"><i class="fa fa-life-ring"></i>
                المبيعات</a>
        </li>
...
<div class="row">
    <div class="col-12">
        <div class="tile">
            <h3 class="tile-title">تعديل | مبيعات الشركة</h3>
            <div class="tile-body">
                <form action="{{ route('admin.sales.company.update',$company->id) }}" method="post">
                    @csrf
                        ...
                        <select class="form-control select2 @error('product') is-invalid @enderror" name="product"
                            ...
                            <optgroup label="اختر نوع المنتج">
                                ...
                                <option value="{{$product->id}}"
                                    {{ $product->id == $company->product_id ? 'selected':''}}>
                                    {{ $product->name }}</option>
                                @endforeach
                            </optgroup>
                        </select>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="buyer_name" id="buyer_name" value="{{ $company->buyer_name }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" min="0.0" step="0.01" name="price" id="price" placeholder="0.00"
                            value="{{ $company->price }}" class="form-control @error('price') is-invalid @enderror"
                            required>
                        @error('price')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
