        ...
        <div class="tile">
            <div class="tile-body">
                ...
                <div class="jumbotron mt-2">
                    ...
                    <hr>
                    <div>{!! $clientConsulting->details !!}</div>
                </div>
                @endif
