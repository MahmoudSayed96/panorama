...
<div class="row">
    <div class="col-12">
        <div class="tile">
            ...
            <div class="tile-body">
                <form action="{{ route('admin.consulting.company.update',$cmpConsulting->id) }}" method="post"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="client_name" id="client_name"
                                    value="{{ $cmpConsulting->client_name }}"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="client_phone" id="client_phone"
                                    value="{{ $cmpConsulting->client_phone }}"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="project_name" id="project_name"
                                    value="{{ $cmpConsulting->project_name }}"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="project_number" id="project_number"
                                    value="{{ $cmpConsulting->project_number }}"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="piece_number" id="piece_number"
                                    value="{{ $cmpConsulting->piece_number }}"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="suk_number" id="suk_number"
                                    value="{{ $cmpConsulting->suk_number }}"
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" name="details" id="editor"
                            class="form-control @error('details') is-invalid @enderror">{!! $cmpConsulting->details !!}</textarea>
                        @error('details')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
