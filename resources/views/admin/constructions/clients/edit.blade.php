...
<div class="row">
    <div class="col-12">
        <div class="tile">
            <h3 class="tile-title">اضافة | مقاولات الشركة</h3>
            <div class="tile-body">
                <form action="{{ route('admin.constructions.clients.update',$clientConstruction->id) }}" method="post"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="client_name" id="client_name"
                                    value="{{ $clientConstruction->client_name }}"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="client_phone" id="client_phone"
                                    value="{{ $clientConstruction->client_phone }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="project_address" id="project_address"
                            value="{{ $clientConstruction->project_address }}"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="paid_amount" id="paid_amount" min="0.0" step="0.01"
                                    value="{{ $clientConstruction->paid_amount }}" placeholder="0.00"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="reaming_amount" id="reaming_amount" min="0.0" step="0.01"
                                    value="{{ $clientConstruction->reaming_amount }}" placeholder="0.00"
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" name="project_details" id="editor"
                            class="form-control @error('project_details') is-invalid @enderror">{{ $clientConstruction->project_details }}</textarea>
