...
<div class="row">
    <div class="col-12">
        ...
        <div class="tile">
            <h2 class="tile-title">مقاولات الشركة</h2>
            @if (currentUser()->hasPermission('create_decorations'))
            <div class="tile-title">
                <a href="{{ route('admin.constructions.company.create') }}" class="btn btn-success">اضاف جديد <i
                        class="fa fa-plus fa-fw fa-lg" aria-hidden="true"></i></a>
            </div>
            @endif
            <div class="tile-body">
                @if (isset($cmpConstructions) && count($cmpConstructions) > 0)
                                    ...
                                    <tbody>
                                        ...
                                        <tr role="row" class="{{ $index % 2 == 0 ? 'even' : 'odd' }}">
                                            ...
                                            <td>
                                                ...
                                                <form
                                                    action="{{ route('admin.constructions.company.delete',$cmp->id) }}"
