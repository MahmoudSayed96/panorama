...
<div class="row">
    <div class="col-12">
        <div class="tile">
            <h3 class="tile-title">تعديل | ديكور للشركة</h3>
            <div class="tile-body">
                <form action="{{ route('admin.decorations.company.update',$cmpDecoration->id) }}" method="post"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="client_name" id="client_name"
                                    value="{{ $cmpDecoration->client_name }}"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="client_phone" id="client_phone"
                                    value="{{ $cmpDecoration->client_phone }}"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" min="0.0" step="0.01" name="paid_amount" id="paid_amount"
                                    placeholder="0.00" value="{{ $cmpDecoration->paid_amount }}"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="delivered_date" id="delivered_date"
                                    value="{{ $cmpDecoration->delivered_date }}"
