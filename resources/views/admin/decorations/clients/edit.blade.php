...
<div class="row">
    <div class="col-12">
        <div class="tile">
            <h3 class="tile-title">تعديل | ديكور عملاء اخرين</h3>
            <div class="tile-body">
                <form action="{{ route('admin.decorations.clients.update',$clientDecoration->id) }}" method="post"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="client_name" id="client_name"
                                    value="{{ $clientDecoration->client_name }}"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="client_phone" id="client_phone"
                                    value="{{ $clientDecoration->client_phone }}"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" min="0.0" step="0.01" name="paid_amount" id="paid_amount"
                                    placeholder="0.00" value="{{ $clientDecoration->paid_amount }}"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="delivered_date" id="delivered_date"
                                    value="{{ $clientDecoration->delivered_date }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="images-container">
                                @foreach ($clientDecoration->photos as $img)
