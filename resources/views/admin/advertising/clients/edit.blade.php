...
<div class="app-title">
    ...
    <ul class="app-breadcrumb breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('admin.advertising.clients') }}"><i class="fa fa-codepen"></i>
                الديكور والاعلان</a>
        </li>
...
<div class="row">
    <div class="col-12">
        <div class="tile">
            <h3 class="tile-title">تعديل | اعلان خارجى</h3>
            <div class="tile-body">
                <form action="{{ route('admin.advertising.clients.update',$clientDesign->id) }}" method="post"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="client_name" id="client_name"
                                    value="{{ $clientDesign->client_name }}"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="client_phone" id="client_phone"
                                    value="{{ $clientDesign->client_phone }}"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" min="0.0" step="0.01" name="paid_amount" id="paid_amount"
                                    placeholder="0.00" value="{{ $clientDesign->paid_amount }}"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="delivered_date" id="delivered_date"
                                    value="{{ $clientDesign->delivered_date }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="images-container">
                                @foreach ($clientDesign->photos as $img)
